  ...
  head: () => ({
    meta: [
      ...
      { title: "Ameer Expo Africa & Middle East 2026 | Register Now" },
      {
        name: "description",
        content:
          "Register for Ameer Expo Africa & Middle East 2026 — 9-11 October, Sarit Expo Centre, Nairobi. Connecting Africa and the Middle East through business, innovation, trade and investment.",
      },
      ...
      { property: "og:title", content: "Ameer Expo Africa & Middle East 2026" },
      {
        ...
        content:
          "The premier business, trade & innovation expo — Nairobi, 9-11 October 2026. Register as a visitor, exhibitor or sponsor.",
      },
    ...
    links: [
      ...
      { rel: "icon", href: "/favicon-64.png?v=3", type: "image/png", sizes: "64x64" },
      { rel: "shortcut icon", href: "/favicon-64.png?v=3" },
