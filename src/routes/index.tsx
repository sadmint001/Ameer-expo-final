  ...
  head: () => ({
    meta: [
      { title: "Ameer Expo Africa & Middle East 2026 | Register Now" },
      {
        name: "description",
        content:
          "Register free for Ameer Expo 2026 — Africa & Middle East's premier business, trade and innovation summit. Sarit Expo Centre, Nairobi, 9-11 October.",
      },
      { property: "og:title", content: "Ameer Expo Africa & Middle East 2026" },
      {
        property: "og:description",
        content:
          "Register for the premier business, trade & investment summit — Nairobi, 9-11 October 2026.",
      },
    ],
  }),
});
